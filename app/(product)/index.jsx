...
const ProductPage = () => {
  ...
  const categories = [
    {
      image: require("../assets/images/product-local/c1.png"),
      title: "All Category",
    },
    {
      image: require("../assets/images/product-local/c2.png"),
      title: "Fashion",
    },
    {
      image: require("../assets/images/product-local/c3.png"),
      title: "Cosmetics",
    },
    {
      image: require("../assets/images/product-local/c4.png"),
      title: "Stationary",
    },
  ];
  ...
  const secondCategory = [
    {
      image: require("../assets/images/product-local/Group 21.png"),
      title: "Footwear",
    },
    {
      image: require("../assets/images/product-local/Group 22.png"),
      title: "Electronics",
    },
    {
      image: require("../assets/images/product-local/Group 23.png"),
      title: "Jewelry",
    },
  ];
  ...
  const handleButtonPress = (button) => {
    ...
    navigation.navigate("SubCatgory", { category: button });
  };
      ...
      <View style={[GStyle.container, GStyle.paddingMd]}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => handleButtonPress("Local")}
          >
            <Text
              style={
                selectedButton === "Local"
          ...
          <TouchableOpacity
            style={[
              styles.button,
              selectedButton === "All Over India"
                ? styles.selectedButton
                : styles.unselectedButton,
            ]}
            onPress={() => handleButtonPress("All Over India")}
          >
            <Text
              style={
                selectedButton === "All Over India"
        ...
        <View style={styles.bannerSection}>
          <Image
            source={require("../assets/images/product-local/sale1.png")}
        ...
        <Image
          source={require("../assets/images/product-local/sale2.png")}
          style={styles.bannerImage}
        />
        ...
        <View style={styles.bigDealsSection}>
          <ImageBackground
            source={require("../assets/images/product-local/rectangle-hot.png")}
            style={styles.rectangleHotImage}
          >
            <Image
              source={require("../assets/images/product-local/ellipse.png")}
          ...
          <Image
            source={require("../assets/images/product-local/girl.png")}
          ...
          <View style={styles.reactRow}>
            <View style={styles.skincareSection}>
              <View style={styles.skincareItem}>
                <Image
                  source={require("../assets/images/product-local/rect1.png")}
                  style={styles.reelimage}
                />
              ...
              <View style={styles.skincareItem}>
                <Image
                  source={require("../assets/images/product-local/rect2.png")}
                  style={styles.reelimage}
                />
              ...
              <View style={styles.skincareItem}>
                <Image
                  source={require("../assets/images/product-local/rect3.png")}
                  style={styles.reelimage}
                />
                <Text style={styles.firstRowText}>Effective Skincare</Text>
                <Text style={styles.secondRowText}>Up To 35% OFF</Text>
          ...
          <View style={styles.brandsSection}>
            ...
            <View style={styles.brandsRow}>
              <View>
                <Image
                  source={require("../assets/images/product-local/brands1.png")}
                  style={styles.reelimage}
                />
                <AntDesign
                  name="caretright"
              ...
              <View>
                <Image
                  source={require("../assets/images/product-local/brands2.png")}
                  style={styles.reelimage}
                />
                <AntDesign
                  name="caretright"
          ...
          <View style={styles.bigDealsSection}>
            <Image
              source={require("../assets/images/product-local/sale3.png")}
            />
          </View>
          ...
          <View style={styles.reactRow}>
            <View>
              <Image
                source={require("../assets/images/product-local/bname1.png")}
            ...
            <View>
              <Image
                source={require("../assets/images/product-local/bname2.png")}
                style={styles.bnameImage}
              />
              <Text style={styles.firstlineText}>Brands Name</Text>
              <Text style={styles.secondlineText}>Under Rs.499</Text>
            ...
            <View>
              <Image
                source={require("../assets/images/product-local/bname3.png")}
                style={styles.bnameImage}
              />
              <Text style={styles.firstlineText}>Brands Name</Text>
              <Text style={styles.secondlineText}>Under Rs.499</Text>
        ...
        <View style={styles.bigDealsSections}>
          ...
          <View style={styles.reactRow}>
            <View>
              <Image
                source={require("../assets/images/product-local/shoes.png")}
                style={styles.bnameImage}
              />
              <AntDesign
                name="caretright"
            ...
            <View>
              <Image
                source={require("../assets/images/product-local/beg.png")}
                style={styles.bnameImage}
              />
              <AntDesign
                name="caretright"
          ...
          <View style={styles.reactRow}>
            <View>
              <Image
                source={require("../assets/images/product-local/budget1.png")}
                style={styles.bnameImage}
              />
            ...
            <View>
              <Image
                source={require("../assets/images/product-local/budget2.png")}
                style={styles.bnameImage}
              />
            ...
            <View>
              <Image
                source={require("../assets/images/product-local/budget3.png")}
                style={styles.bnameImage}
              />
        ...
        <View style={styles.recentReelsSection}>
          ...
          <View style={styles.reactRow}>
            <View>
              <Image
                source={require("../assets/images/product-local/inf1.png")}
                style={styles.bnameImage}
              />
              <AntDesign
                name="caretright"
            ...
            <View>
              <Image
                source={require("../assets/images/product-local/inf2.png")}
                style={styles.bnameImage}
              />
              <AntDesign
                name="caretright"
            ...
            <View>
              <Image
                source={require("../assets/images/product-local/inf3.png")}
                style={styles.bnameImage}
              />
              <AntDesign
                name="caretright"
          ...
          <View style={styles.reactRow}>
            <ImageBackground>
              <Image
                source={require("../assets/images/product-local/handbag1.png")}
            ...
            <ImageBackground>
              <Image
                source={require("../assets/images/product-local/handbag2.png")}
                style={styles.bagImage}
              />
              <View style={styles.textContainer}>
                <Text style={styles.text}>Hand Bags</Text>
            ...
            <ImageBackground>
              <Image
                source={require("../assets/images/product-local/handbag3.png")}
                style={styles.bagImage}
              />
              <View style={styles.textContainer}>
                <Text style={styles.text}>Hand Bags</Text>
        ...
        <View style={styles.bigDealsSection}>
          <ImageBackground
            source={require("../assets/images/product-local/bg.png")}
            style={styles.rectangleHotImages}
          >
            <Image
              source={require("../assets/images/product-local/ellipse1.png")}
          ...
          <Image
            source={require("../assets/images/product-local/hotTrend.png")}
        ...
        <View style={styles.reactRow}>
          <View>
            <Image
              source={require("../assets/images/product-local/dress.png")}
              style={styles.reelimage}
            />
          ...
          <View>
            <Image
              source={require("../assets/images/product-local/shorts1.png")}
              style={styles.reelimage}
            />
          ...
          <View>
            <Image
              source={require("../assets/images/product-local/shorts2.png")}
              style={styles.reelimage}
            />
            <Text style={styles.firstRowText}>Shorts</Text>
            <Text style={styles.secondRowText}>Up To 35% OFF</Text>
