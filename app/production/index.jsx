  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.bannerSection}>
        <Image
          source={require("../assets/images/production/banner.png")}
          style={styles.bannerImage}
        />
        <View style={styles.profileContainer}>
          <Image
            source={require("../assets/images/production/profile.png")}
      ...
      <View style={styles.profileDetails}>
        ...
        <Text style={styles.profileLink}>
          4.5k Rating |<AntDesign name="link" style={styles.profileLink} />{" "}
          Portfolio Onine here
        </Text>
          ...
          <View style={styles.iconContainer}>
            ...
            <TouchableOpacity
              style={[
                ...
                styles.transparentButton,
                selectedButton === "dots-vertical"
                  ? styles.selectedButton
                  : null,
              ]}
              onPress={() => handleButtonPress("dots-vertical")}
            >
              <MaterialCommunityIcons
      ...
      <View style={styles.section}>
        ...
        <View style={styles.sectionHeaderRow}>
          ...
          <TouchableOpacity>
            <Text style={[styles.sectionSeeMore, { color: Colors.grey }]}>
              See More
            </Text>
          </TouchableOpacity>
        </View>
        <ScrollView horizontal={true}>
          <View style={styles.imageRow}>
            <View style={styles.imageContainer}>
              <Image
                source={require("../assets/images/profile/collabo1.png")}
            ...
            <View style={styles.imageContainer}>
              <Image
                source={require("../assets/images/profile/collabo2.png")}
                style={styles.circleImage}
              />
            ...
            <View style={styles.imageContainer}>
              <Image
                source={require("../assets/images/profile/collabo3.png")}
                style={styles.circleImage}
              />
            ...
            <View style={styles.imageContainer}>
              <Image
                source={require("../assets/images/profile/collabo4.png")}
                style={styles.circleImage}
              />
            ...
            <View style={styles.imageContainer}>
              <Image
                source={require("../assets/images/profile/collabo5.png")}
                style={styles.circleImage}
              />
      ...
      <View style={styles.section}>
        ...
        <View style={styles.buttonRow}>
          ...
          >
            <Text
              style={[
                styles.buttonText,
                selectedButton === "Brands" ? styles.selectedButtonText : null,
              ]}
            >
              Brands
            </Text>
          ...
          >
            <Text
              style={[
                styles.buttonText,
                selectedButton === "Series" ? styles.selectedButtonText : null,
              ]}
            >
              Series
            </Text>
        ...
        <View style={styles.imageGrid}>
          <Image
            source={require("../assets/images/production/team1.png")}
            style={styles.gridImage}
          />
          <Image
            source={require("../assets/images/production/team2.png")}
            style={styles.gridImage}
          />
          <Image
            source={require("../assets/images/production/team3.png")}
            style={styles.gridImage}
          />
          <Image
            source={require("../assets/images/production/team4.png")}
            style={styles.gridImage}
          />
          <Image
            source={require("../assets/images/production/team5.png")}
            style={styles.gridImage}
          />
          <Image
            source={require("../assets/images/production/team6.png")}
            style={styles.gridImage}
          />
          <Image
            source={require("../assets/images/production/team7.png")}
            style={styles.gridImage}
          />
          <Image
            source={require("../assets/images/production/team8.png")}
            style={styles.gridImage}
          />
          <Image
            source={require("../assets/images/production/team8.png")}
